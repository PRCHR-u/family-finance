...
class CreditorRead(CreditorBase):
    id: int
    created_at: datetime
    updated_at: datetime
...
class CreditCardIssuerBase(BaseModel):
    name: str = Field(min_length=2, max_length=120)
    description: str | None = Field(default=None, max_length=500)
    is_active: bool = True


class CreditCardIssuerCreate(CreditCardIssuerBase):
    pass


class CreditCardIssuerUpdate(BaseModel):
    name: str | None = Field(default=None, min_length=2, max_length=120)
    description: str | None = Field(default=None, max_length=500)
    is_active: bool | None = None


class CreditCardIssuerRead(CreditCardIssuerBase):
    id: int
    created_at: datetime
    updated_at: datetime
